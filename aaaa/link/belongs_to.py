...
from typing import Callable, Optional, ForwardRef, Any, Dict
...
from aaaa.link.on_delete import OnDelete
...
class BelongsTo(LinkABC):
    ...
    def to_action_fn(self, owner_name: str) -> Callable:
        ...
        linked_store_meta = linked_store_factory.get_store_meta()
