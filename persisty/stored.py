...
from persisty.attr.generator.defaults import get_default_generator_for_create, get_default_generator_for_update
        ...
        for name, type_ in annotations.items():
            ...
            if isinstance(value, Field):
                ...
                if value.default is not MISSING:
                    ...
                    creatable, create_generator = get_default_generator_for_create(name, type_)
            ...
            permitted_filter_ops = TYPE_FILTER_OPS.get(db_type) or DEFAULT_PERMITTED_FILTER_OPS
            attr = Attr(
                name=name,
                attr_type=db_type,
                schema=schema,
