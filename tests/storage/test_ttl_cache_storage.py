...
class TestTtlCacheStorage(TestCase):
    ...
    def test_create(self):
        ...
        self.assertTrue(abs(datetime.now().timestamp() - datetime.now().timestamp()) < 0.01)
    ...
    def test_read_batch(self):
        ...
        updated_item = storage.storage.update(dict(id=items[1]['id'], title='8 Updated'))
    ...
    def test_search(self):
        ...
        new_results.pop(1)
        new_results_2 = list(storage.search_all(FieldFilter('updated_at', FieldFilterOp.lt, timestamp)))
